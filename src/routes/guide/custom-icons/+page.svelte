<script lang="ts">
  import { H2, H3 } from 'runes-webkit';
...
<H3>Svelte 4</H3>
<HighlightCompo lang="ts" code={modules['./examples/create-a-custom-component.md'] as string} />
<H3>Svelte 5</H3>
<HighlightCompo lang="ts" code={modules['./examples/create-a-custom-component-2.md'] as string} />
<p>
...
<H3>Svelete 4</H3>
<HighlightCompo lang="ts" code={modules['./examples/implementation.md'] as string} />
<H3>Svelete 5</H3>
<HighlightCompo lang="ts" code={modules['./examples/implementation-2.md'] as string} />
<p>

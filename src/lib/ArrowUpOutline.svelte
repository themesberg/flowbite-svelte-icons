...
export let ariaLabel="arrow up outline" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="M5 13.327V1.954m0 0L1 5.745m4-3.79 4 3.79"/>  
</svg>

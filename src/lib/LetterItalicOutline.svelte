...
export let ariaLabel="letter italic outline" </script>
...
<svg
  ...
  on:mouseout
>
    <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="m3.874 15 6.143-14M1 15h6.33M6.67 1H13"/> 
</svg>

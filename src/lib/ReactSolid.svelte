<script lang="ts">
	...
	let { size = ctx.size || 'md', role, class: classname, ariaLabel = 'react solid,', ...restProps } = $props<Props>();
</script>
...
>
	...
	/> <path fill="currentColor" d="M12.2 13.8a1.8 1.8 0 1 0-1.8-1.8 1.8 1.8 0 0 0 1.8 1.8Z" />
</svg>

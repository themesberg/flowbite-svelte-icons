...
export let ariaLabel="arrow right alt outline" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="m16.2 19 4.8-7-4.8-7H3l4.8 7L3 19h13.2Z"/>  
</svg>

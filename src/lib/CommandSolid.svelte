...
export let ariaLabel="command solid" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="M8 16V8h8v8H8Zm0-8H6a2 2 0 1 1 2-2v2Zm8 0h2a2 2 0 1 0-2-2v2Zm-8 8H6a2 2 0 1 0 2 2v-2Zm8 0h2a2 2 0 1 1-2 2v-2Z"/>  
</svg>

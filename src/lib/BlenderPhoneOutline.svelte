<script lang="ts">
	...
	let { size = ctx.size || 'md', role, class: classname, ariaLabel = 'blender phone outline,', ...restProps } = $props<Props>();
</script>

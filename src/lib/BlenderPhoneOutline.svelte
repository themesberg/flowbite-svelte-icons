...
strokeWidth= ctx.strokeWidth || "2",
    desc,  
    class: classname, 
    ariaLabel =  "blender phone outline" , 
    onclick, 
    onkeydown, 
    onkeyup, 
    ...restProps 
...
@prop ariaLabel =  "blender phone outline"
@prop onclick
@prop onkeydown
@prop onkeyup
@prop ...restProps

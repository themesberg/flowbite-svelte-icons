...
export let ariaLabel="redo solid" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-width="{strokeWidth}" d="M4 9h12a5 5 0 0 1 5 5v0a5 5 0 0 1-5 5H7"/>   <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="M7 5 3 9l4 4"/>  
</svg>

<script lang="ts">
  ...
  let { 
    ...
    desc,  
    class: className, 
    ariaLabel = "person chalkboard solid" , 
    ...restProps 
    }: Props = $props();

...
<svg
  ...
  on:mouseout
>
     <path fill="currentColor" stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="M9 1.87H1v16h8v-13h5v13h3v-16H9Z"/>  
</svg>

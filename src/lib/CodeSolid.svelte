<script lang="ts">
	...
	let { size = ctx.size || 'md', role, class: classname, ariaLabel = 'code solid,', ...restProps } = $props<Props>();
</script>
...
>
	...
	<path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m14 5-4 14" />
</svg>

...
export let ariaLabel="code solid" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="m8 8-4 4 4 4m8 0 4-4-4-4"/>   <path stroke="currentColor" stroke-linecap="round" stroke-width="{strokeWidth}" d="m14 5-4 14"/>  
</svg>

<script lang="ts">
  ...
  export let ariaLabel = 'code solid';
</script>
...
>
  ...
  /> <path stroke="currentColor" stroke-linecap="round" stroke-width={strokeWidth} d="m14 5-4 14" />
</svg>
...
@prop export let ariaLabel = 'code solid';
-->

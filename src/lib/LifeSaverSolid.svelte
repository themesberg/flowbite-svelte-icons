<script lang="ts">
	...
	let { size = ctx.size || 'md', role, class: classname, ariaLabel = 'life saver solid,', ...restProps } = $props<Props>();
</script>

<script lang="ts">
  ...
  let { 
    ...
    desc,  
    class: className, 
    ariaLabel = "school xmark alt solid" , 
    ...restProps 
    }: Props = $props();

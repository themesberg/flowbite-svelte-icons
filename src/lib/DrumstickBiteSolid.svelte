<script lang="ts">
	...
	let {
		...
		desc,
		class: className,
		ariaLabel = 'drumstick bite solid',
		...restProps
	}: Props = $props();
...
@prop ariaLabel = 'drumstick bite solid'
@prop ...restProps
-->

...
export let ariaLabel="dots horizontal outline" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-width="3" d="M2.49 2h.01m6 0h.01m5.99 0h.01"/>  
</svg>

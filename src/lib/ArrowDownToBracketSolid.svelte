<script lang="ts">
  ...
  export let ariaLabel = 'arrow down to bracket solid';
</script>
...
>
  ...
  /> <path stroke="currentColor" stroke-linecap="round" stroke-width={strokeWidth} d="M12 15.5V4" />
  <path
    stroke="currentColor"
...
@prop export let ariaLabel = 'arrow down to bracket solid';
-->

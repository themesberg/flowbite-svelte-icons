...
export let ariaLabel="chevron double up outline" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="m9 5.196-4-3.79-4 3.79m8 5.686-4-3.79-4 3.79"/>  
</svg>

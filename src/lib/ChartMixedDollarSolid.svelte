<script lang="ts">
  ...
  let { size = ctx.size || 'md', role, class: classname, ariaLabel=  "chart mixed dollar solid"  , ...restProps }: Props = $props();

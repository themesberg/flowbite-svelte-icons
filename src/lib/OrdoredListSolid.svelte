<script lang="ts">
	...
	let { size = ctx.size || 'md', role, class: classname, ariaLabel = 'ordored list solid,', ...restProps } = $props<Props>();
</script>

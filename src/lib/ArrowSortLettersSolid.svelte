...
export let ariaLabel="arrow sort letters solid" </script>
...
<svg
  ...
  on:mouseout
>
     <path stroke="currentColor" stroke-linecap="{strokeLinecap}" stroke-width="{strokeWidth}" d="M7 5v15"/>   <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="{strokeLinejoin}" stroke-width="{strokeWidth}" d="M10 7 7 4 4 7m9-3h6l-6 6h6m-6.5 10 3.5-7 3.5 7M14 18h4"/>  
</svg>

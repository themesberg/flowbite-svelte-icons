<script lang="ts">
  ...
  export let ariaLabel = 'keyboard outline';
</script>
...
<svg
  ...
  on:mouseout
>
  <path fill="#fff" d="M0 0h24v24H0z" /> <path fill="currentColor" d="M18 9Z" />
  <path
    stroke="currentColor"
    stroke-linecap={strokeLinecap}
    stroke-width={strokeWidth}
    d="M20 6H4a1 1 0 0 0-1 1v10c0 .6.4 1 1 1h16c.6 0 1-.4 1-1V7c0-.6-.4-1-1-1ZM8 15h7v0h0-7ZM6 9h0v0h0v0Zm0 3h0v0h0v0Zm0 3h0v0h0v0Zm3-6h0v0h0v0Zm0 3h0v0h0v0Zm3-3h0v0h0v0Zm0 3h0v0h0v0Zm3 0h0v0h0v0Zm3 0h0v0h0v0Zm0 3h0v0h0v0Zm-3-6h0v0h0v0Zm3 0h0v0h0v0Z"
  />
</svg>
...
@prop export let ariaLabel = 'keyboard outline';
-->

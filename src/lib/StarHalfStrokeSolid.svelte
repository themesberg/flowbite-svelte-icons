<script lang="ts">
  ...
  let { size = ctx.size || 'md', role, class: classname, ariaLabel=  "star half stroke solid"  , ...restProps }: Props = $props();

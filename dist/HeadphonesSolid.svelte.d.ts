 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'headphones solid,';
 */
export default class HeadphonesSolid extends SvelteComponent<HeadphonesSolidProps, HeadphonesSolidEvents, HeadphonesSolidSlots> {
}
export {};

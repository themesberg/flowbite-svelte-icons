 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'cart plus outline,';
 */
export default class CartPlusOutline extends SvelteComponent<CartPlusOutlineProps, CartPlusOutlineEvents, CartPlusOutlineSlots> {
}
export {};

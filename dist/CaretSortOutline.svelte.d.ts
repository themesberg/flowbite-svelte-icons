 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'caret sort outline,';
 */
export default class CaretSortOutline extends SvelteComponent<CaretSortOutlineProps, CaretSortOutlineEvents, CaretSortOutlineSlots> {
}
export {};

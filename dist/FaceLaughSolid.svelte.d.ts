 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'face laugh solid,';
 */
export default class FaceLaughSolid extends SvelteComponent<FaceLaughSolidProps, FaceLaughSolidEvents, FaceLaughSolidSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'command outline,';
 */
export default class CommandOutline extends SvelteComponent<CommandOutlineProps, CommandOutlineEvents, CommandOutlineSlots> {
}
export {};

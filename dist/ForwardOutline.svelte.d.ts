 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'forward outline,';
 */
export default class ForwardOutline extends SvelteComponent<ForwardOutlineProps, ForwardOutlineEvents, ForwardOutlineSlots> {
}
export {};

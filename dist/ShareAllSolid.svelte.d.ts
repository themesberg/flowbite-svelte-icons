 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'share all solid,';
 */
export default class ShareAllSolid extends SvelteComponent<ShareAllSolidProps, ShareAllSolidEvents, ShareAllSolidSlots> {
}
export {};

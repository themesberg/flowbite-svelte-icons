 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'hourglass outline,';
 */
export default class HourglassOutline extends SvelteComponent<HourglassOutlineProps, HourglassOutlineEvents, HourglassOutlineSlots> {
}
export {};

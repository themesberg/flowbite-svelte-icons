 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'reply all solid,';
 */
export default class ReplyAllSolid extends SvelteComponent<ReplyAllSolidProps, ReplyAllSolidEvents, ReplyAllSolidSlots> {
}
export {};

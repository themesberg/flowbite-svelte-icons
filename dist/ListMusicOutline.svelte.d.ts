 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'list music outline,';
 */
export default class ListMusicOutline extends SvelteComponent<ListMusicOutlineProps, ListMusicOutlineEvents, ListMusicOutlineSlots> {
}
export {};

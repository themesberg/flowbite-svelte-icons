 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'code fork outline,';
 */
export default class CodeForkOutline extends SvelteComponent<CodeForkOutlineProps, CodeForkOutlineEvents, CodeForkOutlineSlots> {
}
export {};

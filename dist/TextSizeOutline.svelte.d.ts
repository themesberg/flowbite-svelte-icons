 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'text size outline,';
 */
export default class TextSizeOutline extends SvelteComponent<TextSizeOutlineProps, TextSizeOutlineEvents, TextSizeOutlineSlots> {
}
export {};

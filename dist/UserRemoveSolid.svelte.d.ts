 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'user remove solid,';
 */
export default class UserRemoveSolid extends SvelteComponent<UserRemoveSolidProps, UserRemoveSolidEvents, UserRemoveSolidSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'filter outline,';
 */
export default class FilterOutline extends SvelteComponent<FilterOutlineProps, FilterOutlineEvents, FilterOutlineSlots> {
}
export {};

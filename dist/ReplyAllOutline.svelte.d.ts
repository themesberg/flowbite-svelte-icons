 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'reply all outline,';
 */
export default class ReplyAllOutline extends SvelteComponent<ReplyAllOutlineProps, ReplyAllOutlineEvents, ReplyAllOutlineSlots> {
}
export {};

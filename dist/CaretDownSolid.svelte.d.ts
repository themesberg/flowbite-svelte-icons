 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'caret down solid,';
 */
export default class CaretDownSolid extends SvelteComponent<CaretDownSolidProps, CaretDownSolidEvents, CaretDownSolidSlots> {
}
export {};

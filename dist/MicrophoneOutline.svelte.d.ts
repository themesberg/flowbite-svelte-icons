 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'microphone outline,';
 */
export default class MicrophoneOutline extends SvelteComponent<MicrophoneOutlineProps, MicrophoneOutlineEvents, MicrophoneOutlineSlots> {
}
export {};

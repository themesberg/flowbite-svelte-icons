 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'user edit outline,';
 */
export default class UserEditOutline extends SvelteComponent<UserEditOutlineProps, UserEditOutlineEvents, UserEditOutlineSlots> {
}
export {};

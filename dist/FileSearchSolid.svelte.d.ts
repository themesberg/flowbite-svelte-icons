 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'file search solid,';
 */
export default class FileSearchSolid extends SvelteComponent<FileSearchSolidProps, FileSearchSolidEvents, FileSearchSolidSlots> {
}
export {};

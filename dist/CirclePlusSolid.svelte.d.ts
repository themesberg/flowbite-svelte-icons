 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'circle plus solid,';
 */
export default class CirclePlusSolid extends SvelteComponent<CirclePlusSolidProps, CirclePlusSolidEvents, CirclePlusSolidSlots> {
}
export {};

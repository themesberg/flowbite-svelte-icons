 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'file copy solid,';
 */
export default class FileCopySolid extends SvelteComponent<FileCopySolidProps, FileCopySolidEvents, FileCopySolidSlots> {
}
export {};

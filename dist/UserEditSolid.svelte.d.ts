 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'user edit solid,';
 */
export default class UserEditSolid extends SvelteComponent<UserEditSolidProps, UserEditSolidEvents, UserEditSolidSlots> {
}
export {};

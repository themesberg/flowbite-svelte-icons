 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'angle down solid,';
 */
export default class AngleDownSolid extends SvelteComponent<AngleDownSolidProps, AngleDownSolidEvents, AngleDownSolidSlots> {
}
export {};

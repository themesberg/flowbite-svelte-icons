 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'refresh outline,';
 */
export default class RefreshOutline extends SvelteComponent<RefreshOutlineProps, RefreshOutlineEvents, RefreshOutlineSlots> {
}
export {};

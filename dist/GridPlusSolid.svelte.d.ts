 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'grid plus solid,';
 */
export default class GridPlusSolid extends SvelteComponent<GridPlusSolidProps, GridPlusSolidEvents, GridPlusSolidSlots> {
}
export {};

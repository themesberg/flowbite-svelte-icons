 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'file pen outline,';
 */
export default class FilePenOutline extends SvelteComponent<FilePenOutlineProps, FilePenOutlineEvents, FilePenOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'briefcase outline,';
 */
export default class BriefcaseOutline extends SvelteComponent<BriefcaseOutlineProps, BriefcaseOutlineEvents, BriefcaseOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'volume up solid,';
 */
export default class VolumeUpSolid extends SvelteComponent<VolumeUpSolidProps, VolumeUpSolidEvents, VolumeUpSolidSlots> {
}
export {};

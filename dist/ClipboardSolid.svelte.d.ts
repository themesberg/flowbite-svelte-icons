 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'clipboard solid,';
 */
export default class ClipboardSolid extends SvelteComponent<ClipboardSolidProps, ClipboardSolidEvents, ClipboardSolidSlots> {
}
export {};

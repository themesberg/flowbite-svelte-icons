 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'trash bin outline,';
 */
export default class TrashBinOutline extends SvelteComponent<TrashBinOutlineProps, TrashBinOutlineEvents, TrashBinOutlineSlots> {
}
export {};

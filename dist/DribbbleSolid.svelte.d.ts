 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'dribbble solid,';
 */
export default class DribbbleSolid extends SvelteComponent<DribbbleSolidProps, DribbbleSolidEvents, DribbbleSolidSlots> {
}
export {};

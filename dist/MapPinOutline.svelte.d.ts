 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'map pin outline,';
 */
export default class MapPinOutline extends SvelteComponent<MapPinOutlineProps, MapPinOutlineEvents, MapPinOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'pen nib outline,';
 */
export default class PenNibOutline extends SvelteComponent<PenNibOutlineProps, PenNibOutlineEvents, PenNibOutlineSlots> {
}
export {};

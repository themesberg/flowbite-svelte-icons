 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'file copy outline,';
 */
export default class FileCopyOutline extends SvelteComponent<FileCopyOutlineProps, FileCopyOutlineEvents, FileCopyOutlineSlots> {
}
export {};

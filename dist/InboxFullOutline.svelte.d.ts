 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'inbox full outline,';
 */
export default class InboxFullOutline extends SvelteComponent<InboxFullOutlineProps, InboxFullOutlineEvents, InboxFullOutlineSlots> {
}
export {};

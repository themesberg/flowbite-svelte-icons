 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'envelope solid,';
 */
export default class EnvelopeSolid extends SvelteComponent<EnvelopeSolidProps, EnvelopeSolidEvents, EnvelopeSolidSlots> {
}
export {};

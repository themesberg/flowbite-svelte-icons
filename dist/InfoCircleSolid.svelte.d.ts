 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'info circle solid,';
 */
export default class InfoCircleSolid extends SvelteComponent<InfoCircleSolidProps, InfoCircleSolidEvents, InfoCircleSolidSlots> {
}
export {};

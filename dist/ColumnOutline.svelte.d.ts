 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'column outline,';
 */
export default class ColumnOutline extends SvelteComponent<ColumnOutlineProps, ColumnOutlineEvents, ColumnOutlineSlots> {
}
export {};

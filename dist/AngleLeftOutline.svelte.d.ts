 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'angle left outline,';
 */
export default class AngleLeftOutline extends SvelteComponent<AngleLeftOutlineProps, AngleLeftOutlineEvents, AngleLeftOutlineSlots> {
}
export {};

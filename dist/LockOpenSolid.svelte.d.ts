 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'lock open solid,';
 */
export default class LockOpenSolid extends SvelteComponent<LockOpenSolidProps, LockOpenSolidEvents, LockOpenSolidSlots> {
}
export {};

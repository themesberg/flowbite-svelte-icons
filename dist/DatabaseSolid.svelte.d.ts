 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'database solid,';
 */
export default class DatabaseSolid extends SvelteComponent<DatabaseSolidProps, DatabaseSolidEvents, DatabaseSolidSlots> {
}
export {};

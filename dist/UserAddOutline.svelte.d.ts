 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'user add outline,';
 */
export default class UserAddOutline extends SvelteComponent<UserAddOutlineProps, UserAddOutlineEvents, UserAddOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'lock time solid,';
 */
export default class LockTimeSolid extends SvelteComponent<LockTimeSolidProps, LockTimeSolidEvents, LockTimeSolidSlots> {
}
export {};

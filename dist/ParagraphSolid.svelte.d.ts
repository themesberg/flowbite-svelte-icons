 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'paragraph solid,';
 */
export default class ParagraphSolid extends SvelteComponent<ParagraphSolidProps, ParagraphSolidEvents, ParagraphSolidSlots> {
}
export {};

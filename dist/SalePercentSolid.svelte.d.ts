 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'sale percent solid,';
 */
export default class SalePercentSolid extends SvelteComponent<SalePercentSolidProps, SalePercentSolidEvents, SalePercentSolidSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'zoom out outline,';
 */
export default class ZoomOutOutline extends SvelteComponent<ZoomOutOutlineProps, ZoomOutOutlineEvents, ZoomOutOutlineSlots> {
}
export {};

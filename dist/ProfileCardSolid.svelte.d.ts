 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'profile card solid,';
 */
export default class ProfileCardSolid extends SvelteComponent<ProfileCardSolidProps, ProfileCardSolidEvents, ProfileCardSolidSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'file csv outline,';
 */
export default class FileCsvOutline extends SvelteComponent<FileCsvOutlineProps, FileCsvOutlineEvents, FileCsvOutlineSlots> {
}
export {};

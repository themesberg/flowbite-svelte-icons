 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'bell ring solid,';
 */
export default class BellRingSolid extends SvelteComponent<BellRingSolidProps, BellRingSolidEvents, BellRingSolidSlots> {
}
export {};

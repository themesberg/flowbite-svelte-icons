 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'wallet outline,';
 */
export default class WalletOutline extends SvelteComponent<WalletOutlineProps, WalletOutlineEvents, WalletOutlineSlots> {
}
export {};

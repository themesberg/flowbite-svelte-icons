 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'annotation solid,';
 */
export default class AnnotationSolid extends SvelteComponent<AnnotationSolidProps, AnnotationSolidEvents, AnnotationSolidSlots> {
}
export {};

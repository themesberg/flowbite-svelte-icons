 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'terminal solid,';
 */
export default class TerminalSolid extends SvelteComponent<TerminalSolidProps, TerminalSolidEvents, TerminalSolidSlots> {
}
export {};

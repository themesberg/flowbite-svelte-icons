 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'archive outline,';
 */
export default class ArchiveOutline extends SvelteComponent<ArchiveOutlineProps, ArchiveOutlineEvents, ArchiveOutlineSlots> {
}
export {};

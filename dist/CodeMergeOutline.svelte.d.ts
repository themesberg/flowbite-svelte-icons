 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'code merge outline,';
 */
export default class CodeMergeOutline extends SvelteComponent<CodeMergeOutlineProps, CodeMergeOutlineEvents, CodeMergeOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'file check solid,';
 */
export default class FileCheckSolid extends SvelteComponent<FileCheckSolidProps, FileCheckSolidEvents, FileCheckSolidSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'bullhorn outline,';
 */
export default class BullhornOutline extends SvelteComponent<BullhornOutlineProps, BullhornOutlineEvents, BullhornOutlineSlots> {
}
export {};

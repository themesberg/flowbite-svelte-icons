 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'building solid,';
 */
export default class BuildingSolid extends SvelteComponent<BuildingSolidProps, BuildingSolidEvents, BuildingSolidSlots> {
}
export {};

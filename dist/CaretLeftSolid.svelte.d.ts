 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'caret left solid,';
 */
export default class CaretLeftSolid extends SvelteComponent<CaretLeftSolidProps, CaretLeftSolidEvents, CaretLeftSolidSlots> {
}
export {};

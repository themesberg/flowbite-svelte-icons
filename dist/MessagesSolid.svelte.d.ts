 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'messages solid,';
 */
export default class MessagesSolid extends SvelteComponent<MessagesSolidProps, MessagesSolidEvents, MessagesSolidSlots> {
}
export {};

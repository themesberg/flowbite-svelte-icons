 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'lock open outline,';
 */
export default class LockOpenOutline extends SvelteComponent<LockOpenOutlineProps, LockOpenOutlineEvents, LockOpenOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'microphone solid,';
 */
export default class MicrophoneSolid extends SvelteComponent<MicrophoneSolidProps, MicrophoneSolidEvents, MicrophoneSolidSlots> {
}
export {};

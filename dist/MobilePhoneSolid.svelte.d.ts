 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'mobile phone solid,';
 */
export default class MobilePhoneSolid extends SvelteComponent<MobilePhoneSolidProps, MobilePhoneSolidEvents, MobilePhoneSolidSlots> {
}
export {};

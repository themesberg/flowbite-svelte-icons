 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'angle right solid,';
 */
export default class AngleRightSolid extends SvelteComponent<AngleRightSolidProps, AngleRightSolidEvents, AngleRightSolidSlots> {
}
export {};

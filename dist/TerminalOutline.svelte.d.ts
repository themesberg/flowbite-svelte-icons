 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'terminal outline,';
 */
export default class TerminalOutline extends SvelteComponent<TerminalOutlineProps, TerminalOutlineEvents, TerminalOutlineSlots> {
}
export {};

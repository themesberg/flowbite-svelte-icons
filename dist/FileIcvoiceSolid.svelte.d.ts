 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'file icvoice solid,';
 */
export default class FileIcvoiceSolid extends SvelteComponent<FileIcvoiceSolidProps, FileIcvoiceSolidEvents, FileIcvoiceSolidSlots> {
}
export {};

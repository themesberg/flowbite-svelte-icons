 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'tablet outline,';
 */
export default class TabletOutline extends SvelteComponent<TabletOutlineProps, TabletOutlineEvents, TabletOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'briefcase solid,';
 */
export default class BriefcaseSolid extends SvelteComponent<BriefcaseSolidProps, BriefcaseSolidEvents, BriefcaseSolidSlots> {
}
export {};

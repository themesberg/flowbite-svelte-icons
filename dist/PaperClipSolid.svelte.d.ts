 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'paper clip solid,';
 */
export default class PaperClipSolid extends SvelteComponent<PaperClipSolidProps, PaperClipSolidEvents, PaperClipSolidSlots> {
}
export {};

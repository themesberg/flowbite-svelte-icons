 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'palette outline,';
 */
export default class PaletteOutline extends SvelteComponent<PaletteOutlineProps, PaletteOutlineEvents, PaletteOutlineSlots> {
}
export {};

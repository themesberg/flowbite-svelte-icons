 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'printer outline,';
 */
export default class PrinterOutline extends SvelteComponent<PrinterOutlineProps, PrinterOutlineEvents, PrinterOutlineSlots> {
}
export {};

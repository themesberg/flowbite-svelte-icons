 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'table column solid,';
 */
export default class TableColumnSolid extends SvelteComponent<TableColumnSolidProps, TableColumnSolidEvents, TableColumnSolidSlots> {
}
export {};

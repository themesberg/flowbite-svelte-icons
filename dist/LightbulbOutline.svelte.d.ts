 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'lightbulb outline,';
 */
export default class LightbulbOutline extends SvelteComponent<LightbulbOutlineProps, LightbulbOutlineEvents, LightbulbOutlineSlots> {
}
export {};

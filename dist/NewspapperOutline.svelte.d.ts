 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'newspapper outline,';
 */
export default class NewspapperOutline extends SvelteComponent<NewspapperOutlineProps, NewspapperOutlineEvents, NewspapperOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'angle top solid,';
 */
export default class AngleTopSolid extends SvelteComponent<AngleTopSolidProps, AngleTopSolidEvents, AngleTopSolidSlots> {
}
export {};

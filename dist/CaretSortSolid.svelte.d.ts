 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'caret sort solid,';
 */
export default class CaretSortSolid extends SvelteComponent<CaretSortSolidProps, CaretSortSolidEvents, CaretSortSolidSlots> {
}
export {};

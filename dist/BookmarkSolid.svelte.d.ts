 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'bookmark solid,';
 */
export default class BookmarkSolid extends SvelteComponent<BookmarkSolidProps, BookmarkSolidEvents, BookmarkSolidSlots> {
}
export {};

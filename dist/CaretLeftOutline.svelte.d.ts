 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'caret left outline,';
 */
export default class CaretLeftOutline extends SvelteComponent<CaretLeftOutlineProps, CaretLeftOutlineEvents, CaretLeftOutlineSlots> {
}
export {};

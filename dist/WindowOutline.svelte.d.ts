 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'window outline,';
 */
export default class WindowOutline extends SvelteComponent<WindowOutlineProps, WindowOutlineEvents, WindowOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'chart mixed solid,';
 */
export default class ChartMixedSolid extends SvelteComponent<ChartMixedSolidProps, ChartMixedSolidEvents, ChartMixedSolidSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'caret down outline,';
 */
export default class CaretDownOutline extends SvelteComponent<CaretDownOutlineProps, CaretDownOutlineEvents, CaretDownOutlineSlots> {
}
export {};

 ...
 * @props:role?: string;
 * @props:class?: string;
 * @props:ariaLabel?:  string; = 'envelope outline,';
 */
export default class EnvelopeOutline extends SvelteComponent<EnvelopeOutlineProps, EnvelopeOutlineEvents, EnvelopeOutlineSlots> {
}
export {};
